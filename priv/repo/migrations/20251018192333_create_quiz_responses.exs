defmodule Style.Repo.Migrations.CreateQuizResponses do
  ...
  def change do
    create table(:quiz_responses, primary_key: false) do
      ...
      add :question_id, references(:questions, type: :binary_id, on_delete: :restrict), null: false
      add :answer_option_id, references(:answer_options, type: :binary_id, on_delete: :restrict), null: false
